  ...
  return (
    <section id='me'>
      <div className='container'>
        ...
        <h2>Signature</h2>
        <div className='box'>
          <img src='https://img.freepik.com/premium-photo/construction-worker-engineer-studio-portrait-happy-man-vest-helmet-safety-white-background-smile-contractor-architect-planning-renovation-project-manager-india_590464-168030.jpg'></img>
